...
//                         if let Some(Html::Element(ref ele)) = html {
//                             for ref child in ele.children {
                                
//                             }
//                         }
//                         for ref child in html.children {
//                             let child_node = self.arena.new_node(child, 0);
//                             self.arena.add_child(parent_id, child_node);
//                         }
